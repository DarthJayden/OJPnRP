...
//Health and damage fields
	...
	//[CoOp]
	//[SuperDindon]
	qboolean	noFallDamage;  //Prevents fall damage and the falling script for NPCs
	//[/SuperDindon]
...
struct gclient_s {
	...
	int			savedArmor; // MJN for duel Armor
	//[/DuelSys]
...
typedef struct alertEvent_s
{
	...
	//[CoOp]
	qboolean			onGround;	//Did this event occur on the ground?  Used by 
									//CLASS_SAND_CREATURE detect sounds tremors style.
	//[/CoOp]
} alertEvent_t;
...
//[ExpandedMOTD]
//the max number of characters allowed in a center print message.  This is equilent to MAX_STRINGED_SV_STRING,
//which is an engine limitation.
...
//[HolocronFiles]
// UQ1 AOTCTC Holocron table Externs.
extern void AOTCTC_Holocron_Add ( gentity_t *ent );
extern void AOTCTC_Holocron_Loadpositions( void );
extern void AOTCTC_Holocron_Savepositions( void );
extern void AOTCTC_Create_Holocron( int type, vec3_t point );
extern void AOTCTC_Create_Holocrons( void );
//[/HolocronFiles]
